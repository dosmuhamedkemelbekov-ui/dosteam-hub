...
export default function MemberClient({authName,authEmail}:{authName:string;authEmail:string}){
  ...
  return <main className="memberPage">
    <header><a href="/join" className="manageBrand"><div className="brandMark"><span>D</span></div><div><b>DOSTEAM</b><small>MY HUB</small></div></a><nav><a href="/hub">Открыть HUB</a><a href="#tickets">Билеты</a><a href="#clubs">Клубы</a><a href="/api/auth/logout">Выйти</a></nav></header>
